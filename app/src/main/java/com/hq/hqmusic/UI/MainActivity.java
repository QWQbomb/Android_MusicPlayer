...
public class MainActivity extends BaseActivity {
    ...
    //返回adapter
    public MyAdapter returnAdapter(){
        return adapter;
    }
    ...
    private void setpopupwindow() {
        ...
        relativeLayout_skin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //* *NOTICE: Flowing are he problem codes:*
                if(list.isEmpty()==false){
                    editor.putString("song_name",
                            cut_song_name(list.get(currentposition).getSong()));
                    ...
                    text_main.setText("当前没有歌曲:-SetSkin");
                }
    ...
    private void setClick() {
        ...
        imageview = (ImageView) layout_playbar.findViewById(R.id.jump);
    ...
    class SeekBarThread implements Runnable {
        ...
        @Override
        public void run() {//条件中删去&& mplayer.isPlaying()
            while (!ischanging ) {
                // 将SeekBar位置设置到当前播放位置
    ...
    private void frontMusic() {
        if(list.isEmpty()==false)
        {
            ...
            text_main.setText("当前没有歌曲：-Previous");
        }
    ...
    private void random_nextMusic() {
        if(list.isEmpty()==false)
        {
            ...
            text_main.setText("当前没有歌曲：-Random_Next");
        }
